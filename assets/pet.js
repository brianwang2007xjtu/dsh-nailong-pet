...
;(function () {
  ...
  var css =
    ...
    '.nailong-pet-tools{position:absolute;top:-24px;right:0;display:none;gap:6px}' +
    '.nailong-pet-root:hover .nailong-pet-tools,.nailong-pet-tools:hover{display:flex}' +
    '.nailong-pet-btn{width:24px;height:24px;border-radius:12px;border:1px solid #e5e7eb;background:rgba(255,255,255,.92);color:#6b7280;font-size:12px;line-height:1;cursor:pointer;padding:0;box-shadow:0 2px 6px rgba(0,0,0,.15)}' +
